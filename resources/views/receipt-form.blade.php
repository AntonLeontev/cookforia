    ...
    <div class="section">
		<div class="container">
			...
			<form action="/recipe" method="post" class="form">
				...
				<p class="par">Заполняя данную форму, Вы соглашаетесь с условиями <a target="_blank" href="https://cookforia.ru/policy.pdf?ver=09.02.25">Политики в отношении обработки персональных данных</a>.</p>
